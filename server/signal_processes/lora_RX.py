...
class lora_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.zeromq_pub_msg_sink_0 = zeromq.pub_msg_sink('tcp://127.0.0.1:6001', 100, True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.lora_sdr_crc_verif_0, 'msg'), (self.zeromq_pub_msg_sink_0, 'in'))
