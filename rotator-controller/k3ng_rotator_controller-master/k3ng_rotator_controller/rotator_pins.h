...
#define rotate_cw 43              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 45             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
...
#define rotator_analog_az A14     // reads analog azimuth voltage from rotator - pin 4 on Yaesu connector
...
#define rotation_indication_pin 12
#define blink_led 0
#define az_stepper_motor_pulse 0
#define az_rotation_stall_detected 11



/*----------- elevation pins --------------*/
#ifdef FEATURE_ELEVATION_CONTROL
  #define rotate_up 47               // goes high to activate rotator elevation up
  #define rotate_down 49             // goes high to activate rotator elevation down
  ...
  #define rotator_analog_el A15      // reads analog elevation voltage from rotator
...
// rotary encoder pins and options
  ...
  #define el_position_pulse_pin 0 //1                       // must be an interrupt capable pin!
  #define EL_POSITION_PULSE_PIN_INTERRUPT 0 //1             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
#endif                                                // read http://arduino.cc/en/Reference/AttachInterrupt for details on hardware and interrupts
...
#define lcd_4_bit_rs_pin 0 //12
#define lcd_4_bit_enable_pin 0 //11
#define lcd_4_bit_d4_pin 0 //5
#define lcd_4_bit_d5_pin 0 //4
#define lcd_4_bit_d6_pin 0 //3
#define lcd_4_bit_d7_pin 0 //2
  ...
  #define az_hh12_clock_pin 0 //11
  #define az_hh12_cs_pin 0 //12
  #define az_hh12_data_pin 0 //13
#endif //FEATURE_AZ_POSITION_HH_12

#ifdef FEATURE_EL_POSITION_HH12_AS5045_SSI
  #define el_hh12_clock_pin 0 //53 //11
  #define el_hh12_cs_pin 0 //52 //12
  #define el_hh12_data_pin 0 //51 //13
#endif //FEATURE_EL_POSITION_HH_12

#ifdef FEATURE_PARK
  #define park_in_progress_pin 7  // goes high when a park has been initiated and rotation is in progress
  #define parked_pin 6            // goes high when in a parked position
#endif //FEATURE_PARK
...
#define heading_reading_inhibit_pin 0 // input - a high will cause the controller to suspend taking azimuth (and elevation) readings; use when RF interferes with sensors
  ...
  #define az_incremental_encoder_pin_phase_a 0 //18 //3 must be an interrupt capable pin
  #define az_incremental_encoder_pin_phase_b 0 //19 //3 // must be an interrupt capable pin
  #define az_incremental_encoder_pin_phase_z 0 //22 //4
  ...
  #define AZ_POSITION_INCREMENTAL_ENCODER_B_PIN_INTERRUPT 0 //4 //1             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
  ...
  #define el_incremental_encoder_pin_phase_a 0 //2 //18 //2 // must be an interrupt capable pin
  #define el_incremental_encoder_pin_phase_b 0 //3 //19 //3 // must be an interrupt capable pin
  #define el_incremental_encoder_pin_phase_z 0 //5 //22 //4
  #define EL_POSITION_INCREMENTAL_ENCODER_A_PIN_INTERRUPT 0 //0 //5 //0             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
  #define EL_POSITION_INCREMENTAL_ENCODER_B_PIN_INTERRUPT 0 //1 //4 //1             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
                                                                              // read http://arduino.cc/en/Reference/AttachInterrupt for details on hardware and interrupts
  ...
  #define moon_tracking_active_pin 38    // goes high when moon tracking is active
  #define moon_tracking_activate_line 40 // ground this pin to activate moon tracking (not for use with a button)
  #define moon_tracking_button 42        // use with a normally open momentary switch to ground
#endif //FEATURE_MOON_TRACKING

#ifdef FEATURE_SUN_TRACKING
  #define sun_tracking_active_pin 44    // goes high when sun tracking is active
  #define sun_tracking_activate_line 46 // ground this pin to activate sun tracking (not for use with a button)
  #define sun_tracking_button 48      // use with a normally open momentary switch to ground
  ...
  #define pin_sun_pushbutton_calibration 25             // normally HIGH, have button pull LOW
#endif //FEATURE_SUN_PUSHBUTTON_AZ_EL_CALIBRATION

#ifdef FEATURE_MOON_PUSHBUTTON_AZ_EL_CALIBRATION
  #define pin_moon_pushbutton_calibration 27            // normally HIGH, have button pull LOW
...
//#define reset_pin 22 // if defined, goes HIGH to reset unit
  ...
  #define pin_sei_bus_busy 0 //24
  #define pin_sei_bus_send_receive 0 //22  
#endif
...
#define pin_status_led 13   // Status LED - blinks when there is rotation in progress

// Added 2020.07.24.01
#define satellite_tracking_active_pin 32
#define satellite_tracking_activate_line 34
#define satellite_tracking_button 36        // use with a normally open momentary switch to ground
