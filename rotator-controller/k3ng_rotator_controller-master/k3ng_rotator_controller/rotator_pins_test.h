...
#define pins_h
#define rotate_cw 38 //33 //A3 //6             // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector  
#define rotate_ccw 40 //31 //A2 //7            // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
...
#define rotate_up 39 //37 //A5 //9//9               // goes high to activate rotator elevation up
#define rotate_down 41 //35 //A4 //8             // goes high to activate rotator elevation down
